var skills = [
  {
    header: "INTERESTS",
    captions: ["Gaming", "Web", "Mobile", "System Design", "Gen AI"],
    values: [0.7, 0.9, 1.0, 0.9, 0.8],
  },
  {
    header: "LANGUAGES",
    captions: ["C", "Dart", "JS", "Java", "Python"],
    values: [0.8, 0.85, 0.9, 0.7, 0.9],
  },
  {
    header: "Frameworks",
    captions: ["Android", "Flutter", "ExpressJS", "ElectronJS", "NodeJS"],
    values: [1, 1, 0.8, 0.6, 0.8],
  },
  {
    header: "MISC",
    captions: ["Docker", "Git", "Flutter", "Linux", "CI/CD"],
    values: [0.85, 0.96, 1, 1, 0.9],
  },
];
